...
namespace Modules.Grih.RoadTrain
{
    public class Tower : HaveIdItem
    {
        ...
        public int PositionOnTrain => _positionOnTrain;
        ...
        public void SetPositionOnTrain(int value)
        {
            if (value < 10)
                _wagonNumber = 0;
            else
            ...
            _positionOnTrain = value;
            _fullId = (_positionOnTrain * 100) + _idTower;
        }
